          ...
          body: Align(alignment: Alignment.topLeft,
              child: Column(crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    ...
                    Text("Любимые музыкальные группы: "+_dropdownValue),
                    Text("О вас: " + text)]))
      ),
    );
  }
    ...
    return Form(
        ...
        child: Column(
            ...
            children: <Widget>[
              ...
              Container(padding: EdgeInsets.fromLTRB(20, 20, 0, 0),child: CheckboxListTile(value: isChecked, title: const Text("Я собака"), controlAffinity: ListTileControlAffinity.leading,onChanged: (bool? value) {setState(() => isChecked = value!);}),),
              ...
              Container(padding: EdgeInsets.fromLTRB(120, 20, 0, 0), child: Column(children: <Widget>[
                Text("Любимые музыкальные группы:"),
              ...
              TextFormField(onChanged: (String value) {setState(() => {text = value});},minLines: 1, maxLines: 3, keyboardType: TextInputType.multiline, decoration: InputDecoration(hintText: 'О себе', hintStyle: TextStyle(color: Colors.grey), border: OutlineInputBorder(borderRadius: BorderRadius.all(Radius.circular(10.0)),),),),
